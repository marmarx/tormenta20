...
const router = createRouter({
  ...
  routes: [
    ...
    {path: '/magias',          name: 'magias',       component: () => import('@/views/Magias.vue'),        alias: ['/magia']},
    {path: '/magias/:id',      name: 'magiasId',     component: () => import('@/views/Magias.vue'),        alias: ['/magias/:id/']},
    {path: '/magias/:id/edit', name: 'magiasIdedit', component: () => import('@/views/Magias.vue'),        alias: ['/magias/:id/edit/','/magias/:id/editar','/magias/:id/editar/']},
