...
import { filterCheckbox } from '@/stores/constantsStore'

export const createFilterStore = (storeType) => {
  return defineStore(`${storeType}FilterStore`, () => {
    ...
    const filterCheck = filterCheckbox[storeType]
